...
/** Resultado de traducir un error HTTP para las pantallas de CU10. */
export interface ErrorPromociones {
  mensaje: string;
...
/**
 * Traduce errores HTTP del backend para CU10.
 *
 * Se prefiere siempre el `detail` legible del backend porque describe la regla
 * real: valor de descuento inválido, porcentaje mayor a 100, rango de fechas
 * inválido, promoción no encontrada o producto inexistente/inactivo. Los
 * estados globales (401/403/red) conservan el mensaje base de CU03.
 */
export function traducirErrorPromociones(error: unknown): ErrorPromociones {
